...
var createTransformer = (key, check, toValue2, fromValue) => ({
  key,
...
${(0, import_jsesc.default)(script, { quotes: "backtick" })}\`)` : ""}; if (typeof __TSR__ !== 'undefined') __TSR__.cleanScripts()<\/script>`
      );
    };
...
${(0, import_jsesc2.default)(children.toString(), { quotes: "backtick" })}\`)` : "",
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5GTIVHSB.js.map
